...
!function (e, t) {
  ...
  var u = {
    updateSize: function () {
      ...
      var t, i = this.rtl ? this.translate : -this.translate, s = this.slidesGrid, a = this.snapGrid, r = this.params,
        n = this.activeIndex, o = this.realIndex, l = this.snapIndex, h = e;
      if (void 0 === h) {
    ...
    loopCreate: function () {
      ...
      var e, t = this.params, i = this.activeIndex, s = this.slides, a = this.loopedSlides, r = this.allowSlidePrev,
        n = this.allowSlideNext, o = this.snapGrid, l = this.rtl;
    ...
    setTranslate: function () {
      ...
      if (i.css({
        ...
        var C = Math.abs(c) - 90 * Math.floor(Math.abs(c) / 90),
          ...
          k = d.shadowScale / M, $ = d.shadowOffset;
